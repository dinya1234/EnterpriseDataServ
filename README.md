...
Все файлы находятся в testing.zip

1. test_plan — план тестирования
2. test_report — таблица с результатами
3. eedback_summary — анализ отзывов пользователей
4. issues.md — список найденных ошибок и предложений

Тестирование проводилось через функциональную проверку API с помощью curl и PowerShell, а также пользовательское тестирование с участием 4 тестировщиков через Google Forms. По результатам внесены улучшения: добавлены детализированные сообщения об ошибках, создана шпаргалка команд для работы с API и оптимизированы запросы к базе данных для повышения скорости работы.
